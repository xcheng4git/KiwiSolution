...
// CPersonalForm23 窗体视图

class CPersonalForm23 : public CFormView, public CPersonalFormInterface
{
	DECLARE_DYNCREATE(CPersonalForm23)

protected:
	CPersonalForm23();           // 动态创建所使用的受保护的构造函数
	virtual ~CPersonalForm23();

public:
	enum { IDD = IDD_PERSONAL_FORM23 };
#ifdef _DEBUG
